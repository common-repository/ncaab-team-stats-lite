=== NCAA College Basketball Team Stats Lite ===
Contributors: bpmee31
Donate link: http://www.ibet.ws/get_stats.php
Tags: college basketball, ncaa basketball, ncaab, college basketball stats, basketball, nba, ncaab basketball stats, ncaa, ncaa news, sports stats, stats, division 1 basketball, ncaa division 1 basketball, ncaa d1
Requires at least: 2.2.0
Tested up to: 3.0.1
Stable tag: 0.8.2

NCAAB D1A Team Stats allows bloggers display an NCAAB D1A team's standings within their sidebar.

== Description ==

NCAAB D1A Team Stats plugin can be added to any blog with a dynamic sidebar. Once installed, the blogger can choose their favorite NCAAB D1A Team. The stats are updated each week of the NCAAB D1A regular season, so that blog 
visitors can keep track of all the important NCAAB D1A team standings and stats. Additionally, teams qualifying for post-season play are denoted automatically in each stats table with the the standard NCAAB D1A *, x,y or z symbols.
...
This plugin is licensed under WordPress.org guidelines and <a href="http://en.wikipedia.org/wiki/GNU_General_Public_License">General Public License</a>. Examples of acceptable sites are sports blogs, <a href="http://www.bet-on-the-nfl.com" target="_blank">NFL betting</a> sites, entertainment and stats, as well as top <a href="http://www.more-online-casinos.us" target="_blank">online casinos</a> websites.
...
1. Upload `ncaab-d1a-team-stats` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. The Plugin will automatically install a new option entry in your wp.options database table.
4. Go to your Design section and select the NCAAB D1A Stats widget.
...
= Why is there so much "inline" CSS displayed in my NCAAB D1A Stats table? =
